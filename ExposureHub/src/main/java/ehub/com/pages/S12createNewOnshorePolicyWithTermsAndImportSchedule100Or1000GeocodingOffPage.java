...
public class S12createNewOnshorePolicyWithTermsAndImportSchedule100Or1000GeocodingOffPage {
	
	//private WebDriver driver;
	CommonLocatorsAndMethod common;

	public S12createNewOnshorePolicyWithTermsAndImportSchedule100Or1000GeocodingOffPage(WebDriver driver) {
		//this.driver = driver;
	...
	public String createNewPolicy(String policyNumber) {
		 String createdPolicyVerify =common.createNewPolicyWithClassNameAndCoverageRule(policyNumber, AppConstants.policy_Assured + "12", 2, AppConstants.className_two_class_With_Same_Name);
	...
	public String editAndimportSchedule1000(String verificationMessage) {
	...
	public String deleteSingleSchedule(String verificationMessage) {
		String actual=common.deleteScheduleGeneric(AppConstants.class_Cyber_Fraction_Value, 1, verificationMessage);
		return actual;
	}
