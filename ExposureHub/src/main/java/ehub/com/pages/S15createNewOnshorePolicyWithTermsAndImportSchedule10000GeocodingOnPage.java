...
public class S15createNewOnshorePolicyWithTermsAndImportSchedule10000GeocodingOnPage {
	
	//private WebDriver driver;
	CommonLocatorsAndMethod common;

	public S15createNewOnshorePolicyWithTermsAndImportSchedule10000GeocodingOnPage(WebDriver driver) {
		//this.driver = driver;
	...
	public String createNewPolicy(String policyNumber) {
		 String createdPolicyVerify =common.createNewPolicyWithClassName(policyNumber, AppConstants.policy_Assured + "15", 2, AppConstants.className_two_class_With_Same_Name);
