...
public class S09copyPolicyPage {

	// private WebDriver driver;
	CommonLocatorsAndMethod common;

	public S09copyPolicyPage(WebDriver driver) {
		// this.driver = driver;
	...
	public String createNewPolicy(String policyNumber) {
		String actual = common.createNewPolicyWithClassNameAndCoverageRule(policyNumber,
				AppConstants.policy_Assured + "S09", 2, AppConstants.className_two_class_With_Same_Name);
		return actual;
	}
	...
	public String copyPolicy(String policyNumber) {
		String actual=common.copyNewPolicyFromPolicyPage(policyNumber, "Yes");
		return actual;
	}
}
